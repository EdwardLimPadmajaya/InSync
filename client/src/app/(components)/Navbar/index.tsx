...
const Navbar = () => {
    return (
        <div className='flex items-center justify-between w-full px-4 py-4 bg-white dark:bg-dark-bg'>
        {/* Search Bar */}
        ...
        <div className='flex items-center'>
            ...
            <div className='ml-2 mr-5 hidden min-h-[2em] w-[0/1rem] bg-gray-200 md:incline-block'>
